...
<?php
	...
	$param_wpayToken 		= $_GET["wpayToken"];		// 이니시스에서 발행한 wpayToken  - (SEED 암호화 대상필드)
	...
	if (strcmp($param_resultCode, "0000") == 0) {
		...
		$param_wpayToken 	= decrypt_SEED($param_wpayToken, $g_SEEDKEY, $g_SEEDIV);
		...
		*/
		...
		// URL Decoding 처리
		$param_resultMsg = urldecode($param_resultMsg, "UTF-8");
