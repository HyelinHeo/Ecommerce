...
$param_userId = $_GET["userId"];  // 가맹점 유저ID(Request userId 필드 데이터) - (SEED 암호화 대상필드)
$param_wpayUserKey = $_GET["wpayUserKey"]; // 이니시스에서 발행한 wpayUserKey  - (SEED 암호화 대상필드)
$param_ci = $_GET["ci"]; // 가맹점 고객의 ci  - (SEED 암호화 대상필드)
...
if (strcmp($param_resultCode, "0000") == 0) {
	...
	// Seed 복호화 처리
	$param_userId = decrypt_SEED($param_userId, $g_SEEDKEY, $g_SEEDIV);
	$param_wpayUserKey = decrypt_SEED($param_wpayUserKey, $g_SEEDKEY, $g_SEEDIV);
	$param_ci = decrypt_SEED($param_ci, $g_SEEDKEY, $g_SEEDIV);
								...
								<tr>
									<td style="text-align:left;">
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><b>userId</b>
												<br/><input  style="width:100%;" name="userId" value="<?php echo $param_userId ?>" >

												<br/><b>wpayUserKey</b>
												<br/><input  style="width:100%;" name="wpayUserKey" value="<?php echo $param_wpayUserKey ?>" >
												
												<br/><b>ci</b>
												<br/><input  style="width:100%;" name="ci" value="<?php echo $param_ci ?>" >
