  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('notifications.create.users') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.notification_create_users')}}</a>
        </li>
        @endcan
        @can('notifications.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('notifications.create.orders') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.notification_create_orders')}}</a>
        </li>
        @endcan
