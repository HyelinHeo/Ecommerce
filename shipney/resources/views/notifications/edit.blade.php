    ...
    <div class="card">
      <div class="card-header">
        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
          <li class="nav-item">
            <a class="nav-link active" href="#users_fields"><i class="fa fa-cog mr-2"></i>{{trans('lang.user_list')}}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="#orders_fields"><i class="fa fa-cog mr-2"></i>{{trans('lang.order_list')}}</a>
          </li>
        </ul>
      </div>
      <div class="card-body">
        <div class="tab-content mb30">
          @include('notifications.users_fields')
          @include('notifications.orders_fields')
        </div>
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
