...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::text('nation', null,  ['class' => 'form-control','placeholder'=>  trans("lang.faq_nation_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.faq_nation_help") }}
    </div>
  </div>
</div>
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::text('language', null,  ['class' => 'form-control','placeholder'=>  trans("lang.faq_language_placeholder")]) !!}
    <div class="form-text text-muted">
      {{ trans("lang.faq_language_help") }}
    </div>
  </div>
</div>
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::select('faq_category_code', $faqCategory, null, ['class' => 'select2 form-control']) !!}
    <div class="form-text text-muted">{{ trans("lang.faq_faq_category_code_help") }}</div>
  </div>
</div>
