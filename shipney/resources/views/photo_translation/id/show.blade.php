...
<div class="content">
  <div class="card">
    <div class="card-header d-print-none">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <div class="ml-auto d-inline-flex">
          ...
          <li class="nav-item">
            <a class="nav-link pt-1" href="{{ route('photoTranslationsID.edit', $order->id) }}"><i class="fa fa-edit"></i> {{trans('lang.photo_translation_edit')}}</a>
          </li>
          @endcan
          @can('photoTranslationsID.destroy')
          <li class="nav-item">
            {!! Form::open(['route' => ['photoTranslationsID.destroy', $order->id], 'method' => 'delete']) !!}
    ...
    <div class="card-body">
      <div class="row">
        @include('photo_translation.id.show_fields')
      </div>
      <div class="clearfix"></div>
      <div class="row d-print-none">
        <!-- Back Field -->
        <div class="form-group col-12 text-right">
          <a href="{!! route('photoTranslationsID.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
        </div>
      </div>
      <div class="clearfix"></div>
    </div>
