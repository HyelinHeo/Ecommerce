...
class User extends Authenticatable implements HasMedia
{
    ...
    protected $casts = [
        ...
        'phone' => 'string',
        'country_code' => 'string',
        'country_digit' => 'string',
        'language_code' => 'string',
        'photo' => 'string',
        'extra_info' => 'string',
        'friend_auto_add' => 'string',
        'friend_allow_add_me' => 'string',
        'allow_notify' => 'string',
        'allow_notify_shipping' => 'string',
        'allow_notify_event' => 'string',
        'allow_notify_notice' => 'string',
        'allow_notify_lockscreen' => 'string',
        'agree_privacy' => 'string',
        'agree_terms' => 'string',
        'agree_mobile' => 'string',
        'agree_over_14' => 'string'
    ];
    /**
     * New Attributes
     *
