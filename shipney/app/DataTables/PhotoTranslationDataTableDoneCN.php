<?php
/**
 * File name: PhotoTranslationDataTableDoneCN.php
...
class PhotoTranslationDataTableDoneCN extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('id', function ($order) {
                return getRouteColumn($order, 'id', 'photoTranslationsCN.show');
            })
