<?php
/**
 * File name: PhotoTranslationDataTableDoneMY.php
...
class PhotoTranslationDataTableDoneMY extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('id', function ($order) {
                return getRouteColumn($order, 'id', 'photoTranslationsMY.show');
            })
