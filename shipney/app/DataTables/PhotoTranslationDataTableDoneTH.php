<?php
/**
 * File name: PhotoTranslationDataTableDoneTH.php
...
class PhotoTranslationDataTableDoneTH extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('id', function ($order) {
                return getRouteColumn($order, 'id', 'photoTranslationsTH.show');
            })
