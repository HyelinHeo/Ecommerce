<?php
/**
 * File name: PhotoTranslationDataTableDoneID.php
...
class PhotoTranslationDataTableDoneID extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('id', function ($order) {
                return getRouteColumn($order, 'id', 'photoTranslationsID.show');
            })
