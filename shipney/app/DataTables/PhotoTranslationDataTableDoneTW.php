<?php
/**
 * File name: PhotoTranslationDataTableDoneTW.php
...
class PhotoTranslationDataTableDoneTW extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('id', function ($order) {
                return getRouteColumn($order, 'id', 'photoTranslationsTW.show');
            })
