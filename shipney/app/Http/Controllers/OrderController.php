...
class OrderController extends Controller
{
    ...
    public function show(ProductOrderDataTable $productOrderDataTable, $id)
    {
        ...
        return $productOrderDataTable->render('orders.show', ["order" => $order, "total" => $total, "subtotal" => $subtotal,"taxAmount" => $taxAmount,"payments" => $order->payments, "pickupInformations" => $order->pickupInformations]);
    }
    ...
    public function edit($id)
    {
        ...
        ->with("user", $user)
        // ->with("driver", $driver)
        ->with("orderStatus", $orderStatus)->with("user_email", $user_email);
    }
    ...
    public function update($id, UpdateOrderRequest $request)
    {
        ...
        $request->has('pickup_request')!=null?$request['pickup_request']="Y":$request['pickup_request']="N";
        $request->has('pickup_jeju')!=null?$request['pickup_jeju']="Y":$request['pickup_jeju']="N";
        $request->has('pickup_island')!=null?$request['pickup_island']="Y":$request['pickup_island']="N";
