<?php
/**
 * File name: PhotoTranslationController.php
...
use App\DataTables\PhotoTranslationDataTable;
...
class PhotoTranslationController extends Controller
{
    /** @var  OrderRepository */
     ...
     *
     * @param PhotoTranslationDataTable $photoTranslationDataTable
     * @return Response
     */
    public function index(PhotoTranslationDataTable $photoTranslationDataTable)
    {
        return $photoTranslationDataTable->render('photo_translation.index');
    }
    ...
    public function store(CreateOrderRequest $request)
    {
        ...
        return redirect(route('photoTranslations.index'));
    }
    ...
    public function show(PhotoTranslationDataTable $PhotoTranslationDataTable, $id)
    {
        ...
        return $PhotoTranslationDataTable->render('photo_translation.show', ["order" => $order]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('photo_translation.edit')
        ->with('order', $order)
        ->with("user", $user)
