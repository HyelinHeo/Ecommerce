...
class UserController extends Controller
{
    ...
    public function update($id, UpdateUserRequest $request)
    {
        ...
        $request->has('friend_auto_add')!=null?$request['friend_auto_add']="Y":$request['friend_auto_add']="N";
        $request->has('friend_allow_add_me')!=null?$request['friend_allow_add_me']="Y":$request['friend_allow_add_me']="N";
        $request->has('allow_notify')!=null?$request['allow_notify']="Y":$request['allow_notify']="N";
        $request->has('allow_notify_shipping')!=null?$request['allow_notify_shipping']="Y":$request['allow_notify_shipping']="N";
        $request->has('allow_notify_event')!=null?$request['allow_notify_event']="Y":$request['allow_notify_event']="N";
        $request->has('allow_notify_notice')!=null?$request['allow_notify_notice']="Y":$request['allow_notify_notice']="N";
        $request->has('allow_notify_lockscreen')!=null?$request['allow_notify_lockscreen']="Y":$request['allow_notify_lockscreen']="N";
        $request->has('agree_privacy')!=null?$request['agree_privacy']="Y":$request['agree_privacy']="N";
        $request->has('agree_terms')!=null?$request['agree_terms']="Y":$request['agree_terms']="N";
        $request->has('agree_mobile')!=null?$request['agree_mobile']="Y":$request['agree_mobile']="N";
