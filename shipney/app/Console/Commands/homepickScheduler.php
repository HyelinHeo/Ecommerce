...
use App\Http\Controllers\HomepickController; 
...
class homepickScheduler extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'RequestHomepickSync:send';
     ...
     * @var string
     */
    protected $description = 'Homepick data sync';
    ...
    {
        $req = Request::create('api/datasync/homepick', 'GET');
        $res = app()->handle($req);
