...
//        'PayPal' => Srmklive\PayPal\Facades\PayPal::class,
    ...
    |--------------------------------------------------------------------------
    |
    | This array of class notification is define the status of each notification.
    |
    |
    */

    'notification' => [
        'NOTIFICATION_TYPE_ORDER_STATE' => 'ocs',
        'NOTIFICATION_TYPE_ORDER_REPAY' => 'orp',
        'NOTIFICATION_TYPE_ORDER_ALERT' => 'oat',
